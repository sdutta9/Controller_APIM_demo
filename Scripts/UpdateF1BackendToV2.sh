...
result=$(newman run -k ./PostmanCollections/3_Controller3.x_deploy_F1_V2.postman_collection.json -e  ./temp_env.json --bail newman --reporters html)
echo "Newman result: $result"
rm ./temp_env.json